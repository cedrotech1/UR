                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <script>
                                                                    function confirmDelete(regnumber, names) {
                                                                        if (confirm('Are you sure you want to delete the product ' + names + '?')) {
                                                                            window.location.href = 'product-delete.php?regnumber=' + regnumber;
                                                                        } else {
                                                            ...
                                                            <div class="col-3">
                                                                <a
                                                                    href="product-update.php?pid=<?php echo $row['regnumber']; ?>">
                                                                    <button class="btn" data-bs-toggle="tooltip"
                                                            ...
                                                            <div class="col-3">
                                                                <a
                                                                    href="view_products.php?regnumber=<?php echo $row['regnumber']; ?>">
                                                                    <button class="btn" data-bs-toggle="tooltip"
